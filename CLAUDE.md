...
A single-file Sudoku game (`index.html`) built with [Juris.js](https://unpkg.com/juris@0.88.2/juris.js), loaded from unpkg at runtime. No build step, no package.json, no local dependencies.
